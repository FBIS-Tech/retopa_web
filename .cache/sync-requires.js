...
exports.components = {
  ...
  "component---src-pages-dealer-dashboard-history-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\Dealer_Dashboard\\History.jsx"))),
  "component---src-pages-dealer-dashboard-hooks-use-display-hooks-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\Dealer_Dashboard\\hooks\\useDisplayHooks.jsx"))),
  ...
  "component---src-pages-index-js": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\index.js"))),
  "component---src-pages-login-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\Login.jsx"))),
  "component---src-pages-merchants-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\Merchants.jsx"))),
  "component---src-pages-new-password-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\NewPassword.jsx"))),
  "component---src-pages-nfc-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\NFC.jsx"))),
  "component---src-pages-page-2-js": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\page-2.js"))),
  "component---src-pages-password-reset-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\PasswordReset.jsx"))),
  "component---src-pages-privacy-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\Privacy.jsx"))),
  "component---src-pages-sign-up-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\SignUp.jsx"))),
  "component---src-pages-sub-dealer-dashboard-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\Sub_Dealer\\Dashboard.jsx"))),
  ...
  "component---src-pages-terms-conditions-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\Terms&Conditions.jsx"))),
  "component---src-pages-user-dashboard-dash-history-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\User_Dashboard\\Dash_history.jsx"))),
  "component---src-pages-user-dashboard-dashboard-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\User_Dashboard\\Dashboard.jsx"))),
  "component---src-pages-user-dashboard-hook-display-hooks-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\User_Dashboard\\hook\\displayHooks.jsx"))),
  "component---src-pages-user-dashboard-hook-use-top-up-hooks-jsx": hot(preferDefault(require("D:\\YU\\Documents\\retopa\\src\\pages\\User_Dashboard\\hook\\useTopUpHooks.jsx"))),
